...
class Araba { // Class isimlerinin baş harfinin büyük olması gerekir.
    var renk:String?
    var hiz:Int?
    ...
    init(renk:String,hiz:Int,calisiyorMu:Bool){
        ...
        self.hiz = hiz
        self.calisiyorMu = calisiyorMu // Shadowing : Gölgeleme (Mülakatlarda sorulabilir.)
...
class Fonksiyonlar {
    ...
    // Overloading (Aynı fonksiyon isimlerini tekrar tekrar kulanabilmek için)
...
let f1 = Filmler(film_id: 1, film_adi: "Django", film_yil: 2013, kategori: k1, yonetmen: y1)
